classdef SignalsDefaultExpPanel < eui.SignalsExpPanel
    % DEFAULT EXPPANEL CODE FOR STEINMETZLAB
    % This class is supposed to abstract out a bunch of the annoying stuff
    % in the ExpPanel. It will automatically generate an obj.Block structure
    % with all of the events in your task. 
    ...
    methods
        function obj = SignalsDefaultExpPanel(parent, ref, params, logEntry)
