...
p.databaseURL = 'https://alyx.internationalbrainlab.org/';%'http://alyx.steinmetzlab.net'; % 'https://dev.alyx.internationalbrainlab.org/';
...
% permanently
p.workingAnalysisRepository = fullfile(server1Name, 'temp');
