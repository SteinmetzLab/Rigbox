classdef SignalsOutputSyringePump2 < hw.SignalsOutput
  ...
  methods
    function obj = SignalsOutputSyringePump2(name,devID)
...
%         fprintf('pump on for %s seconds, %s ul \n', num2str(dt,3), num2str(volume))
    end
